  ...
  return (
    <div className="dropdown">
      ...
      {isOpen && (
        ...
        onMouseOut={() => setIsOpen(false)} className="dropdown-menu">
...
const navMobApp: NavItem[] = [
  ...
  { component: <NavLink to="https://docs.thenextgem.ai/" title="Documentation" /> },
  ...
  { component: <NavLink to="/gems" title="Gems" /> },
  {
    component: (
      <Dropdown
        title="SERVICES"
        items={[
          <NavLink to="/premium" title="Premium" />,
          <NavLink to="/staking" title="Staking" />,
          <NavLink
        to="https://docs.thenextgem.ai/"
        title="Documentation"
        isExternal
      ...
      <div className="header-bottom">
        ...
        <div className="header-wrapper">
          ...
          <div ref={navRef} className="header-wrapper-content header-app">
            ...
            >
              <Nav items={navResponsive? navMobApp: navApp} />
            </div>
            <Button
              icon="carbon:menu"
              minus
