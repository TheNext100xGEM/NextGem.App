...
import { Button, BuyNextGemButton, OpenAppButton, Logotype } from '@components/ui'
import { CHAT_NAME, SOUND_BUTTON_CLICK, VOLUME_BUTTON_CLICK } from '@constants/index'
...
const navLanding: NavItem[] = [
  { component: <NavLink to="/#solutions" title="Solutions" /> },
  { component: <NavLink to="/#products" title="Products" /> },
  { component: <NavLink to="/#contact" title="Contact" /> },
...
const navApp: NavItem[] = [
  ...
  { component: <Panel /> },
  { component: <Button icon="carbon:settings" minus color="secondary" title="Settings" /> },
  { component: <Button href="/" icon="carbon:close" minus color="secondary" title="Close" /> },
]
