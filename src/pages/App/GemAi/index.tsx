...
import { CHAT_NAME, SITE_NAME, SOUND_BUTTON_CLICK, SOUND_BUTTON_HOVER, SOUND_SEND_MESSAGE, TOKEN_NAME, VOLUME_BUTTON_CLICK, VOLUME_BUTTON_HOVER } from '@constants/index'
...
function GemAiPage() {
  ...
  const FormAi = () => {
    ...
    const ButtonSend = <Button icon="carbon:send" minus color="tertiary" pathSoundClick={SOUND_SEND_MESSAGE} />
    const ButtonLocked = <Button icon="carbon:locked" minus color="tertiary" status="warning" className="locked" />
        ...
        <div className="ai-chat-form-text">
          <TextareaAutosize 
            ...
            <div className="btn-right">
              {access ? ButtonSend : ButtonLocked}
            </div>
            <Corner color="primary" />
          </div>
        <p>{CHAT_NAME} can make errors. Remember to check important information.</p>
      </div>
    )
  }
  ...
  const List = () => {
    ...
    const Item = ({ title }: PropsConversation) => {
      const actions = [
        <Button icon="carbon:pen" color="tertiary">Rename</Button>,
        <Button icon="carbon:trash-can" color="secondary" status="danger">Delete Chat</Button>,
      ]
        ...
        <div className="start">
          ...
          {!access && <>
            <Alert status="warning">
              You don't have access to <strong>{CHAT_NAME}</strong>, go burn <strong>{TOKEN_NAME}</strong> to unlock access.
            </Alert>
            <Button href="/staking" icon="carbon:shopping-cart" status="success">Buy access now</Button>
          </>}
        </div>
      )
    }
  ...
  return (
    <>
      <Helmet>
        <title>{SITE_NAME} — {CHAT_NAME}</title>
      </Helmet>
      <div className="ai">
        <List />
        <Button 
